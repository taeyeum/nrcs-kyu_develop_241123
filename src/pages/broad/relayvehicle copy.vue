      ...
      <div class="col-lg-12">
        <div class="card card-primary" style="height:800px;">
                  ...
                  <div class="col-5">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="#">중계</a></li>
                        <li><a class="dropdown-item" href="#">MNG</a></li>                       
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-primary card-outline" style="height:560px;">
                  <div class="row">
                    ...
                    <!-- /.card-header -->   
                        ...
                        <div class="col-11">
                          <div class="input-group ml-3 mt-n2">
                            &ensp;&ensp;&ensp;&ensp;제목&ensp;
                            <input type="text" class="form-control form-control-sm " placeholder="아침날씨중계"  aria-describedby="basic-addon2"
                          style="">                               
                  ...
                  <div class="col-5">
                   ...
                   <div class="col-10">
                            <div class="form-group ml-3 mt-2">
                              중계차량&ensp;
                              <button class="btn btn-sm btn-outline-secondary dropdown-toggle " style="width:140px;" type="button" data-bs-toggle="dropdown" aria-expanded="false"
                          >
                                OVAN
                              </button>                      
                          </div>
                    ...
                    <div class="col-11">
                      <div class="input-group ml-3 mt-n2">
                        중계감독&ensp;
                        <input type="text" class="form-control form-control-sm " placeholder="김감독"  aria-describedby="basic-addon2"
                          style="">                               
                  ...
                  <div class="col-11">
                      <div class="input-group ml-3 mt-2">
                        중계요원&ensp;
                        <input type="text" class="form-control form-control-sm " placeholder="아무개1,아무개2,아무개3"  aria-describedby="basic-addon2"
                          style="">                               
...
import relayplan from '../../components/broad/relayvehicle/Relayplan1.vue'
