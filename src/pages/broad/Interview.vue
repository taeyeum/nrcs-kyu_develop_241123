                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-4">
                      <div class="button-group">
                        ...
                        <button type="button" class="btn btn-info btn-sm mx-1 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal2"
                        >      
                          수정
                        ...
                        <button class="btn btn-info btn-sm mx-1 mb-2">                
                         ...
                         <button type="button" class="btn btn-info btn-sm  mb-2 mx-1"  data-bs-toggle="modal" data-bs-target="#exampleModal4"                    
                        >  기사맵핑
                  ...
                  <div class="tab-pane fade show active " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">       
                    <div class="card " style="height:300px;">
                          <div class="row text-sm mx-1">
                            <div class="col-lg-12 ">
                              <div class="input-group mt-2 ">
                                계획구분&ensp;
                                <div class="col-lg-6">
                                <select class="form-select form-select-sm"  aria-label="Default select example" v-model="rinfos.division">                                    
                          ...
                          <div class="col-lg-12 mt-2">
                            ...
                            <input type="text" class="form-control form-control-sm " placeholder=""  aria-describedby="basic-addon2"  v-model="rinfos.reporter">                     
                              &ensp;
