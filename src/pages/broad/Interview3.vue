            ...
            <div class="row gx-1"  >
              ...
              <div class="col-lg-4  ml-n2">
                ...
                <div class="col-12 mb-2 mt-3">      
                  ...
                  <router-link to="/interview3"><button type="submit" class="btn btn-sm btn-primary"><i class="far fa-save"></i>계획이력</button></router-link>
                  <router-link to="/interview4"><button type="submit" class="btn btn-sm btn-outline-secondary"><i class="far fa-save"></i> 기사화</button></router-link>
                    ...
                    <div class="card " style="height:350px;">
                       <div class="row text-sm mx-1">
                            <div class="col-lg-12">
                              ...
                              일자&ensp;
                              <input type="date" class="form-control form-control-sm " placeholder="아무개"  aria-describedby="basic-addon2"
                              style=""> 
                              </div>
                            </div>                         
      
                            <div class="col-lg-6 mt-2 ">&ensp;&ensp;&ensp;&ensp;
