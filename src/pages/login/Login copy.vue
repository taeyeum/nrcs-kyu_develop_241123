<template>
  ...
  <div class="login-box container" style="margin-top: 10%;">
    <div class="card card-outline card-primary" style="height:380px; background-color:#09a8de">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <p class="mb-n2">아이디</p>
         <hr style="width:300px; margin-top: 5px;" />        
        ...
        <div class="form-group">
          ...
          <button @click="Login()" class="btn btn-outline-light btn-block" style="width:100px; height:32px; position: relative; left:65%; top:-50px; padding:0;">
              인증
            </button>
        </div>
      </div>
