                          ...
                          <div class="col-lg-12">
                              <div class="button-group mt-2 ">
                                  <div class="col-lg-12 mb-2 ">      
                                     ...
                                     <router-link to="/CharacterAlinksns"><button type="submit" class="btn btn-sm btn-outline-secondary"><i class="fa-sharp-duotone fa-solid fa-file-lines"></i>&ensp;내용</button></router-link>
                                      ...
                                      <router-link to="/CharacterAlinkreq"><button type="submit" class="btn btn-sm btn-primary"><i class="fa-sharp-duotone fa-solid fa-file-lines"></i>&ensp;의뢰상태</button></router-link>
